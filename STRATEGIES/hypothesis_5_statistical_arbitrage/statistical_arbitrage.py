...
class StatisticalArbitrageStrategy(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.position_size_per_pair = float(self.GetParameter("position_size_per_pair", 1))
        ...
        self.z_entry_threshold = float(self.GetParameter("z_entry_threshold", 1.5))
        self.z_exit_threshold = float(self.GetParameter("z_exit_threshold", 1))
        self.lookback_period = int(self.GetParameter("lookback_period", 30))
